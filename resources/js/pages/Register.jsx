            ...
            <div className="square-reg">
                ...
                <div className="sqr2-reg">
                        <form onSubmit={handleRegister} className="form-container-reg">
                            ...
                            <div className="bdate-input">
                                <input type="date" id="birth_date" placeholder="Birth Date" value={formData.birth_date} onChange={(e) => setFormData({...formData, birth_date:e.target.value})} required />
                            </div>
